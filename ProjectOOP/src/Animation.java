...
public class Animation {
	...
	public void drawAnimationWizard(Graphics g, double x, double y, int offset){
		g.drawImage(currentImg, (int)x - offset, (int)y, 32, 32+27, null);
	}
	
	public void drawAnimationEnemy(Graphics g, double x, double y, int offset){
		g.drawImage(currentImg, (int)x - offset, (int)y, 32+32, 36+32, null);
	}
	
	public void drawAnimationEnemy2(Graphics g, double x, double y, int offset){
