...
public class EnemyBig extends GameObject {
    ...
    public EnemyBig(int x, int y, ID id, Handler handler, SpriteSheet ss) {
        super(x, y, id, ss);
        this.handler = handler;
     
        enemy_image_idle[0] = ss.grabImageEnemy(1, 1, 32, 36); 
        enemy_image_idle[1] = ss.grabImageEnemy(2, 1, 32, 36); 
        enemy_image_idle[2] = ss.grabImageEnemy(3, 1, 32, 36); 
        enemy_image_idle[3] = ss.grabImageEnemy(4, 1, 32, 36);
        
        enemy_image_run[0] = ss.grabImageEnemy(5, 1, 32, 36); 
        enemy_image_run[1] = ss.grabImageEnemy(6, 1, 32, 36); 
        enemy_image_run[2] = ss.grabImageEnemy(7, 1, 32, 36); 
        enemy_image_run[3] = ss.grabImageEnemy(8, 1, 32, 36);
    ...
    public void render(Graphics g) {
        ...
        if (velX == 0 && velY == 0) {
            animIdle.drawAnimationEnemy(g2d, 0, 0, 0);
        } else {
            animRun.drawAnimationEnemy(g2d, 0, 0, 0);
        }
